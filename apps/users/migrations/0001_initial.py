...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='John', max_length=20, validators=[django.core.validators.RegexValidator('^([A-Z][A-Za-z]{1,19})$')])),
                ('surname', models.CharField(default='Doe', max_length=20, validators=[django.core.validators.RegexValidator('^([A-Z][A-Za-z]{1,19})$')])),
